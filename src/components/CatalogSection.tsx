...
export function CarCard({ title, image, tags = [], meta = [], specs, price, slug }: CarCardProps) {
    return (
        <Link to={`/catalog/${slug}`} className="bg-white rounded-[16px] border border-[#e6e6e6] overflow-hidden flex flex-col group cursor-pointer hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[24px]">
         {[...Array(8)].map((_, i) => (
             <CarCard
               ...
               specs={{ hp: "625 л.с.", zeroTo100: "3.3 сек" }}
               price="$138,889"
      ...
      <Pagination className="mt-8 max-w-[800px] mx-0 justify-start px-[12px] py-[10px] bg-white rounded-[12px]">
        <PaginationContent className="gap-2">
          <PaginationItem>
            <PaginationPrevious
              href="#"
              className="h-[40px] px-[16px] py-[10px] rounded-[12px] bg-white text-[#141414] border border-[#e6e6e6] hover:bg-neutral-50 flex items-center justify-center hover:-translate-y-[1px] transition"
            />
          </PaginationItem>
          <PaginationItem>
            <PaginationLink
          ...
          <PaginationItem>
            <PaginationLink
              href="#"
              className="w-[40px] h-[40px] rounded-[12px] bg-white text-[#141414] border border-[#e6e6e6] hover:bg-neutral-50 flex items-center justify-center px-0 hover:-translate-y-[1px] transition"
            >
              2
            </PaginationLink>
          </PaginationItem>
          ...
          <PaginationItem>
            <PaginationEllipsis className="w-[40px] h-[40px] rounded-[12px] bg-white border border-[#e6e6e6] hover:bg-neutral-50" />
          </PaginationItem>
          <PaginationItem>
            <PaginationLink
              href="#"
