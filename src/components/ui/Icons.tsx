...
import svgPaths from "./icons-data";
...
export const LogoIcon = ({ className }: { className?: string }) => (
    <svg className={className} fill="none" viewBox="0 0 97 40">
...
export const HorsePowerIcon = () => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <path d={svgPaths.p1a6e4100} stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export const SpeedIcon = () => (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        ...
        <path d={svgPaths.p1a6375c0} stroke="currentColor" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
